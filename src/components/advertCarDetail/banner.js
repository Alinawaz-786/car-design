        ...
        <>
            ...
            <BackgroundImage src='/assets/banners/detail-bg.png' style={{ backgroundColor: '#040509' }} c={dark ? '#fff' : '#fff'} ta={'center'}>
                <Container size='lg' py={100}>
                    ...
                    {carData?.make} <Text component='span' fz={'inherit'} fw={600} c={'#2BAA9B'}> {carData?.model} ({carData?.year})</Text>
                    </Title>
                    ...
                    <Group align='center' justify='center'>
                        ...
                        {/* <Button variant='outline' color='#2BAA9B' c={dark ? '#fff' : '#fff'} size='md' ml={{ base: '0', md: '20'}} radius='xl'
                            leftSection={
                                <IconEdit width={20} />
                            }
                            onClick={() => open()}

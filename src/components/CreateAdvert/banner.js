            ...
            <Container size="xl" py={{ base: 60, md: 80 }}>
                <Grid>
                    <Grid.Col span={{ base: 12, md: 6 }}>
                        <Text component="span" fz={{ base: 22, sm: 25, md: 30 }} lh={1} c='#2BAA9B'>Sell my car</Text>
                        ...
                        <Box pos='relative' display='inline-block' mb={{ base: 30, md: 40 }}>
                            ...
                            <Text component="span" fz={{ base: 22, md: 30 }} c='#2BAA9B' pos='absolute' right={0} bottom={{ base: -28, md: -34 }}>Sales</Text>
                        </Box>
                        ...
                        <List
                            ...
                            icon={
                                <ThemeIcon color="none" size={24} radius="xl">
                                    <IconCheck color='#2BAA9B' style={{ width: rem(20), height: rem(20) }} />
                                </ThemeIcon>   
                            }
                        >

        ...
        <MantineProvider forceColorScheme="light" theme={theme}>
            <Container size='md' p={{ base: '60 0 0', sm: '100 0 0' }} c={dark ? '#fff' : '#000'} ta={'center'}>
                <Title order={2} fz={{ base: 32, sm: 40, lg: 45 }} mb={{ base: '5', sm: '20' }}>
                    Create <Text component='span' fz={'inherit'} fw={600} c={'#2BAA9B'}>Account</Text>
                </Title>
                <Text mb={{ base: '20', sm: '30' }}>Already have an account? <Link href='#' style={{ color: '#2BAA9B' }}>Sign in</Link></Text>
            </Container>

                                ...
                                <div className={style.cardBgDark}>
                                    <div className="p-7">
                                        <div className="status-info1">
                                            <div className="bgSvg">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="#2BAA9B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="tabler-icon tabler-icon-list-check" style={{ width: "calc(3.125rem * var(--mantine-scale))", height: "calc(3.125rem * var(--mantine-scale))" }}><path d="M3.5 5.5l1.5 1.5l2.5 -2.5"></path><path d="M3.5 11.5l1.5 1.5l2.5 -2.5"></path><path d="M3.5 17.5l1.5 1.5l2.5 -2.5"></path><path d="M11 6l9 0"></path><path d="M11 12l9 0"></path><path d="M11 18l9 0"></path></svg>
                                            </div>
                            ...
                            <Grid.Col span={{ lg: 4, md: 12 }}>
                                <div className={style.cardBgDark}>
                                    <div className="p-7">
                                        <div className="">
                                            <div className="">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="#2BAA9B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="tabler-icon tabler-icon-user" style={{ width: "calc(3.125rem * var(--mantine-scale))", height: "calc(3.125rem * var(--mantine-scale))" }}><path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0"></path><path d="M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2"></path></svg>
                                            </div>
                            ...
                            <Grid.Col span={{ lg: 4, md: 12 }}>
                                <div className={style.cardBgDark}>
                                    <div className="p-7">
                                        <div className="status-info1">
                                            <div className="">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="#2BAA9B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="tabler-icon tabler-icon-shopping-cart" style={{ width: "calc(3.125rem * var(--mantine-scale))", height: "calc(3.125rem * var(--mantine-scale))" }}><path d="M6 19m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0"></path><path d="M17 19m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0"></path><path d="M17 17h-11v-14h-2"></path><path d="M6 5l14 1l-1 7h-13"></path></svg>
                                            </div>
